...
interface IEKSEC2InstancesTable {
    tableData: any[];
    loading?: boolean;
}

export default function EKSEC2InstancesTable({ tableData, loading }: IEKSEC2InstancesTable) {
    ...
    const columns: GridColDef[] = [
        ...
        { field: 'NodeGroupName', headerName: 'Node Group', width: 150 },
    ...
    const rows = tableData.map((data, index) => ({
        ...
        ClusterName: data?.ClusterName || 'N/A',
        NodeGroupName: data?.NodeGroupName || 'N/A',
    ...
    const handleExport = () => {
        ...
        const filename = `EKS_EC2_Instances_${moment().format('YYYY-MM-DD_HHmmss')}.csv`;
